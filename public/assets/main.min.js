...
if (typeof loadMaskBack !== 'function') {
                        ...
                        if ($file.val() !== "") {
                            ...
                            $.each($.parseJSON($file.val()), function (i, e) {
                                ...
                                if (e.type.match(/image.*/))
                                    ...
                                    myDropzone.emit("thumbnail", mockFile, HOME + VENDOR + "form/public/assets/img/file.png", HOME + e.url);
...
if (typeof formSubmit !== 'function') {
    ...
    function statusPanel(status, $form) {
        ...
        } else if (status === "no-network") {
        } else if (status !== "change") {
            toast("Salvo", 2000, "toast-success");
        } else {
            btnHtml = "<img src='" + HOME + "assetsPublic/img/save.gif' style='width: 25px;float: left;margin-right: 15px;' />Enviando"
        }
...
function checkInputUnique($this, val) {
    if ($this.hasClass("cep") && val.length === 9) {
        ...
        post('form', 'read/cepAberto', {cep: val}, function (g) {
            try {
                g = $.parseJSON(g);
...
if (typeof formAutoSubmit !== 'function') {
    ...
    function requestPreDataToSelecaoUnique(id, entity, field) {
        ...
        post("form", "read/selecaoUniquePreData", {id: id, entity: entity, field: field}, function (g) {
            if (g) {
